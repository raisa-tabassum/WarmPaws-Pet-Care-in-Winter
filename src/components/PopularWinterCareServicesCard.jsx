  ...
  return (
    <div className="card bg-base-200 w-96 shadow-lg px-2 rounded-2xl">
      ...
      <div className="card-body space-y-1">
        <h2 className="card-title text-left text-[21px] font-bold">
          {serviceName}
        </h2>
        <div className="flex gap-30">
          <p className="text-xl font-semibold text-gray-600 flex items-center gap-1">
            <span>
        ...
        <button className="btn btn-primary mt-2 mx-24 bg-blue-900 text-white">
          <Link to={`/service/${service.serviceId}`}>View Details</Link>
        </button>{" "}
      </div>
    </div>
  );
